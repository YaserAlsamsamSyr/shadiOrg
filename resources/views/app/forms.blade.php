...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">الإستمارات</h1>
                    ...
                    <div class="testimonial-item text-center">
                        ...
                        <div class="testimonial-text rounded text-center p-4">
                                 ...
                                 <table align="center" style="direction: rtl">
                                        ...
                                        <tr>
                                            <td>الحساب</td><td>{{ $form->user->email }}</td>
                                        </tr>
                                        <tr>
                                            <td>العنوان</td><td>{{ $form->user->address }}</td>
                                        </tr>
                                        <tr>
                                            <td>رقم الهاتف</td><td>{{ $form->user->phone }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        @if(Route::current()->getName() == 'form.wait')
                                        <form method="post" action="{{ route('form.update') }}">
                                            <tr>
                                                <td>حالة الطلب</td><td>
                                                        ...
                                                        <label> 
                                                            <input type="radio" id="true" name="status" value="مقبول">
                                                            قبول
                                                        </label><br>
                                                        <label>
                                                            <input type="radio" id="true" name="status" value="مرفوض">
                                                            رفض
                                                        </label>
                                                </td>
                                            </tr>
